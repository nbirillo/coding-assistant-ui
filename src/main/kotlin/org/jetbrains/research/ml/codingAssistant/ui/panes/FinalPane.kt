...
class FinalController(project: Project, scale: Double, fxPanel: JFXPanel, id: Int) :
    ...
    @FXML
    lateinit var backToProfileButton: Button

    @FXML
    lateinit var backToProfileText: Text

    @FXML
    lateinit var greatWorkLabel: Label
