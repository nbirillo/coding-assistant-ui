...
open class LanguagePaneUiData : PaneUiData() {
    companion object {
        val language = ListedUiField(
            PluginServer.availableLanguages,
            0,
...
open class LanguagePaneController(project: Project, scale: Double, fxPanel: JFXPanel, id: Int) :
    PaneController(
        project,
        scale,
        fxPanel,
    ...
    override fun update() {
        logger.info(
            "${Plugin.PLUGIN_NAME} update controller ${this::javaClass.name}, " +
