...
class SuccessController(project: Project, scale: Double, fxPanel: JFXPanel, id: Int) :
    ...
    @FXML
    lateinit var firstNonBoldText: Text

    @FXML
    lateinit var secondNonBoldText: Text
    lateinit var nonBoldTexts: List<Text>

    @FXML
    lateinit var firstBoldText: Text
    ...
    @FXML
    private lateinit var yellowPolygon: Polygon
