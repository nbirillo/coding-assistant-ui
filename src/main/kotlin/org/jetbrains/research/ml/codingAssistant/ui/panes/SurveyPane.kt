package org.jetbrains.research.ml.codingAssistant.ui.panes
...
import org.jetbrains.research.ml.codingAssistant.models.Country
import org.jetbrains.research.ml.codingAssistant.models.Gender
...
import org.jetbrains.research.ml.codingAssistant.tracking.*
...
interface ProgrammingLanguageNotifier : Consumer<Int> {
    companion object {
        val PROGRAMMING_LANGUAGE_TOPIC =
            Topic.create("programming language change", ProgrammingLanguageNotifier::class.java)
    }
}
...
//        Todo: make it autocomplete https://stackoverflow.com/questions/19924852/autocomplete-combobox-in-javafx
        ...
        subscribe(
            CountryComparatorNotifier.COUNTRY_COMPARATOR_TOPIC,
            object : CountryComparatorNotifier {
    ...
    private fun initProgrammingLanguage() {
        ...
        subscribe(
            ProgrammingLanguageNotifier.PROGRAMMING_LANGUAGE_TOPIC,
            object : ProgrammingLanguageNotifier {
    ...
    private fun makeTranslatable() {
        subscribe(
            LanguageNotifier.LANGUAGE_TOPIC,
            object : LanguageNotifier {
                override fun accept(newLanguageIndex: Int) {
