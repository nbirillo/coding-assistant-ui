...
class TaskSolvingController(project: Project, scale: Double, fxPanel: JFXPanel, id: Int) :
    ...
    @FXML
    lateinit var taskInputHeaderText: Text

    @FXML
    lateinit var taskInputText: Text

    @FXML
    lateinit var taskOutputHeaderText: Text
    ...
    @FXML
    lateinit var sendSolutionButton: Button

    @FXML
    lateinit var sendSolutionText: Text

    @FXML
    lateinit var backToTasksButton: Button

    @FXML
    lateinit var backToTasksText: Text
    ...
    @FXML
    private lateinit var greenPolygon: Polygon
    ...
    private fun initTaskInfo() {
        ...
        subscribe(
            ChosenTaskNotifier.CHOSEN_TASK_TOPIC,
            object : ChosenTaskNotifier {
