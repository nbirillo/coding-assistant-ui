package org.jetbrains.research.ml.tasktracker.ui.window
...
import org.jetbrains.research.ml.tasktracker.ui.window.HintDiffWindow

fun DiffManager.showHintDiff(
    project: Project,
    original: String,
    hint: String,
    onCloseHandler: BooleanGetter = BooleanGetter { true },
    onApplyHandler: BooleanGetter = BooleanGetter { true }
) {
    ...
    HintDiffWindow(project, chain, DiffDialogHints.MODAL, onCloseHandler, onApplyHandler).show()
}
